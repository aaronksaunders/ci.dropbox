...
// in simulator we redefine to format for dropboxapi Developer console
...
{\
	NSString * exceptionName = [@"org.dropboxapi." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dropboxapi";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIdropboxapiNativeItemNone = -1, 
	UIdropboxapiNativeItemSpinner = -2,
	UIdropboxapiNativeItemProgressBar = -3,
	
	UIdropboxapiNativeItemSlider = -4,
	UIdropboxapiNativeItemSwitch = -5,
	UIdropboxapiNativeItemMultiButton = -6,
	UIdropboxapiNativeItemSegmented = -7,
	
	UIdropboxapiNativeItemTextView = -8,
	UIdropboxapiNativeItemTextField = -9,
	UIdropboxapiNativeItemSearchBar = -10,
	
	UIdropboxapiNativeItemPicker = -11,
	UIdropboxapiNativeItemDatePicker = -12,
	
	UIdropboxapiNativeItemInfoLight = -13,
	UIdropboxapiNativeItemInfoDark = -14,
	
	UIdropboxapiNativeItemDisclosure = -15,
	
	UIdropboxapiNativeItemContactAdd = -16
};
