...
@interface dropboxapiObject : KrollCoverageObject {
#else
@interface dropboxapiObject : KrollObject {
#endif
@private
...
extern NSString * dropboxapi$ModuleRequireFormat;
