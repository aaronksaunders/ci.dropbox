 ...
 * Copyright (c) 2009-2011 by dropboxapi, Inc. All Rights Reserved.
...
//@interface dropboxapiObject : NSObject
//@end

@interface dropboxapiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[dropboxapiObject class]])
		{
			for (NSString *key in [[(dropboxapiObject*)o modules] allKeys])
			{
